...
<div class="container">
    ...
    <div class="branch-form-container compact-form">
        <form method="POST" action="{{ route('doctor.branches.store') }}" enctype="multipart/form-data" id="branchForm">
            @csrf
            
            <!-- Profile Photo Upload - Circular Container at Top -->
            <div class="profile-upload-container">
                <div class="profile-image-wrapper">
                    <img id="adminPhotoPreviewImg" class="profile-image-preview" src="#" alt="Admin Photo Preview" />
            ...
            <div class="form-row">
                <div class="modern-input-wrapper">
                    ...
                    <div class="modern-input-container">
                        ...
                        <input type="text" id="name" name="name" value="{{ old('name') }}" placeholder="Start typing your branch name..." required>
                    </div>
                    @error('name')
                ...
                <div class="modern-input-wrapper">
                    ...
                    <div class="modern-input-container">
                        ...
                        <input type="text" id="address" name="address" value="{{ old('address') }}" placeholder="Start typing your address..." required>
                    </div>
                    @error('address')
                        <span class="error-message">{{ $message }}</span>
                    @enderror
            ...
            <div class="form-row">
                <div class="modern-input-wrapper">
                    ...
                    <div class="modern-input-container">
                        ...
                        <input type="text" id="phone" name="phone" value="{{ old('phone') }}" placeholder="Start typing your phone number..." required>
                    </div>
                    @error('phone')
                        <span class="error-message">{{ $message }}</span>
                    @enderror
                ...
                <div class="modern-input-wrapper">
                    ...
                    <div class="modern-input-container">
                        ...
                        <input type="email" id="email" name="email" value="{{ old('email') }}" placeholder="Start typing your email..." required>
                    </div>
                    @error('email')
                        <span class="error-message">{{ $message }}</span>
                    @enderror
            ...
            <div class="form-row">
                <div class="modern-input-wrapper">
                    ...
                    <div class="modern-input-container">
                        ...
                        <input type="password" id="password" name="password" class="has-right-icon" placeholder="Start typing your password..." minlength="6" required>
                        <i class="fas fa-eye-slash input-icon-right" id="togglePassword"></i>
                    </div>
                    <small style="color: #6c757d; font-size: 0.8rem; display: block; margin-top: 0.25rem;">Minimum 6 characters</small>
                    @error('password')
                        <span class="error-message">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="modern-input-wrapper">
                    ...
                    <div class="modern-input-container">
                        <i class="fas fa-lock input-icon"></i>
                        <input type="password" id="password_confirmation" name="password_confirmation" class="has-right-icon" placeholder="Start typing your password..." minlength="6" required>
            ...
            <div class="form-actions">
                <button type="submit" class="btn btn-primary" style="padding: 0.6rem 1.5rem; font-size: 0.95rem;">Create Branch</button>
