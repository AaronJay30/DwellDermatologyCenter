                ...
                <tbody>
                    @forelse($appointments as $appointment)
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="doctor-appointment-status-select" data-appointment-id="{{ $appointment->id }}" data-prev-status="{{ $appointment->status }}" style="padding: 0.35rem 0.5rem; min-width: 110px;">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const baseUrl = '{{ url("/doctor/my-appointments") }}';
    ...
    document.querySelectorAll('.doctor-appointment-status-select').forEach(function(sel) {
        sel.addEventListener('change', function() {
            ...
            fetch(`${baseUrl}/${id}`, {
                ...
                else if (sel) sel.setAttribute('data-prev-status', status);
    ...
    if (progressPhotosForm) {
        progressPhotosForm.addEventListener('submit', function(e) {
            ...
            fetch(`${baseUrl}/${currentAppointmentId}/progress-photos`, {
                method: 'POST',
