...
<div class="container">
    <div class="slot-form-container compact-form">
        <form method="POST" action="{{ route('doctor.slots.update', $slot) }}" id="slotForm">
            @csrf
            @method('PUT')
            ...
            <div class="form-row">
                <div class="modern-input-wrapper">
                    ...
                    <div class="modern-input-container">
                        ...
                        <input type="time" id="start_time" name="start_time" value="{{ old('start_time', $slot->start_time) }}" required>
                    </div>
                    @error('start_time')
                        <span class="error-message">{{ $message }}</span>
                    @enderror
                ...
                <div class="modern-input-wrapper">
                    ...
                    <div class="modern-input-container">
                        <i class="fas fa-clock input-icon"></i>
                        <input type="time" id="end_time" name="end_time" value="{{ old('end_time', $slot->end_time) }}" required>
                    </div>
                    @error('end_time')
                        <span class="error-message">{{ $message }}</span>
                    @enderror
            ...
            <div class="form-actions">
                ...
                <a href="{{ route('doctor.slots') }}" class="btn btn-accent" style="padding: 0.6rem 1.5rem; font-size: 0.95rem;">Cancel</a>
            </div>
        </form>
    </div>
</div>
