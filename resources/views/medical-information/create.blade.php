...
<div class="form-container">
    <div class="page-header">
        ...
        <h1 class="page-title">Add Medical Information</h1>
    </div>
    ...
    <div class="form-card">
        <form action="{{ route('medical-information.store') }}" method="POST">
            @csrf
            ...
            <div class="form-group">
                ...
                <div style="margin-top: 0.5rem;">
                    <input type="text" id="comorbidities_others" name="comorbidities_others" class="form-input" 
                           value="{{ old('comorbidities_others') }}" placeholder="Others, please specify">
                </div>
            </div>

            <div class="form-group">
                <label for="allergies" class="form-label">Allergies</label>
                <textarea name="allergies" id="allergies" class="form-textarea" placeholder="List any allergies">{{ old('allergies') }}</textarea>
            </div>

            <div class="form-group">
                <label for="medications" class="form-label">Medications</label>
                <textarea name="medications" id="medications" class="form-textarea" placeholder="List current medications">{{ old('medications') }}</textarea>
            </div>

            <div class="form-group">
                <label for="anesthetics" class="form-label">Anesthetics</label>
                <textarea name="anesthetics" id="anesthetics" class="form-textarea" placeholder="List any anesthetics">{{ old('anesthetics') }}</textarea>
                <input type="text" id="anesthetics_others" name="anesthetics_others" class="form-input" 
                       style="margin-top: 0.5rem;" value="{{ old('anesthetics_others') }}" placeholder="Others, please specify">
            </div>

            <div class="form-group">
                <label for="previous_hospitalizations_surgeries" class="form-label">Previous hospitalizations / surgeries</label>
                <textarea name="previous_hospitalizations_surgeries" id="previous_hospitalizations_surgeries" class="form-textarea" placeholder="List previous hospitalizations or surgeries">{{ old('previous_hospitalizations_surgeries') }}</textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea name="known_family_illnesses" id="known_family_illnesses" class="form-textarea" placeholder="List known family illnesses">{{ old('known_family_illnesses') }}</textarea>
            </div>
