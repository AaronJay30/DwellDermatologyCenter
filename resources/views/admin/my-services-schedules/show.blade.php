...
<div class="container">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem;">
        ...
        <a href="{{ route('admin.my-services-schedules') }}" class="btn btn-accent">Back to Services Schedules</a>
    </div>
...
<div id="confirmModal" class="modal" style="display:none; position:fixed; inset:0; background:rgba(0,0,0,.4); align-items:center; justify-content:center; z-index:1000;">
...
<div id="cancelModal" class="modal" style="display:none; position:fixed; inset:0; background:rgba(0,0,0,.4); align-items:center; justify-content:center; z-index:1000;">
    <div class="card" style="width:min(520px, 92vw); border:1px solid #eef1f4;">
...
<!-- Add Result Modal -->
<div id="addResultModal" class="modal" style="display:none; position:fixed; inset:0; background:rgba(0,0,0,.4); align-items:center; justify-content:center; z-index:1000; overflow-y: auto; padding: 20px;">
    <div class="card" style="width:min(800px, 95vw); border:1px solid #eef1f4; max-height: 90vh; overflow-y: auto;">
...
function confirmServiceSchedule(appointmentId) {
    ...
    form.action = `/admin/my-services-schedules/${appointmentId}/confirm`;
...
function cancelServiceSchedule(appointmentId) {
    ...
    form.action = `/admin/my-services-schedules/${appointmentId}/cancel`;
...
function addServiceResult(appointmentId) {
    ...
    form.action = `/admin/my-services-schedules/${appointmentId}/result`;
