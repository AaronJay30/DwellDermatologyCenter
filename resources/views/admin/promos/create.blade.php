...
<style>
    ...
    /* Responsive styles for date/time fields */
...
<div class="container">
    ...
    <form method="POST" action="{{ route('admin.promos.store') }}" enctype="multipart/form-data" id="promoForm">
        @csrf
        ...
        <div class="form-actions" style="display: flex; gap: 1rem; margin-top: 2rem;">
            ...
            <a href="{{ route('admin.promos') }}" class="btn" style="flex: 1; padding: 1rem; font-size: 1.1rem; text-align: center; text-decoration: none; background: #6c757d; color: white; border-radius: 8px;">
                Cancel
            </a>
        </div>
    </form>
