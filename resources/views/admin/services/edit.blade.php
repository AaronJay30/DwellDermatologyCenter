...
<style>
    ...
    .existing-photo-item.removed {
        opacity: 0.4;
        border-style: dotted;
    }

    .existing-photo-item .remove-checkbox {
        display: none;
    }
</style>
                        ...
                        <div class="existing-photos-container">
                            @foreach($service->images as $img)
                                <div class="existing-photo-item" data-image-id="{{ $img->id }}">
                                    ...
                                    <input type="checkbox" name="remove_image_ids[]" value="{{ $img->id }}" class="remove-checkbox">
...
<script>
function toggleRemoveExisting(button) {
    const container = button.closest('.existing-photo-item');
    const checkbox = container.querySelector('.remove-checkbox');
    const isChecked = !checkbox.checked;
    checkbox.checked = isChecked;
    container.classList.toggle('removed', isChecked);
}
