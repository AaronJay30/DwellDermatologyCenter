        ...
        <form method="POST" action="{{ route('admin.services.store') }}" enctype="multipart/form-data" id="serviceForm">
            ...
            <div class="service-photos-section">
                <div class="modern-input-wrapper">
                    <label style="font-weight: bold; margin-bottom: 0.5rem; display: block;">Images</label>
            ...
            <div class="form-row">
                <div class="modern-input-wrapper">
                    ...
                    <div class="modern-input-container">
                        ...
                        <input type="text" id="name" name="name" value="{{ old('name') }}" placeholder="Start typing service name..." required>
                    </div>
                    @error('name')
                        <span class="error-message">{{ $message }}</span>
                    @enderror
            ...
            <div class="form-row">
                <div class="modern-input-wrapper">
                    ...
                    <div class="modern-input-container">
                        ...
                        <input type="number" id="duration_minutes" name="duration_minutes" step="1" min="1" value="{{ old('duration_minutes', 30) }}" placeholder="30" required>
                    </div>
            ...
            <div class="modern-input-wrapper">
                ...
                <div class="modern-input-container">
                    ...
                    <textarea id="description" name="description" rows="4" placeholder="Enter service description...">{{ old('description') }}</textarea>
                </div>
                @error('description')
                    <span class="error-message">{{ $message }}</span>
                @enderror
            ...
            <div class="form-actions">
                <button type="submit" class="btn btn-primary" style="padding: 0.6rem 1.5rem; font-size: 0.95rem;">Create Service</button>
                <a href="{{ route('admin.services') }}" class="btn btn-accent" style="padding: 0.6rem 1.5rem; font-size: 0.95rem;">Cancel</a>
            </div>
        </form>
    </div>
</div>
