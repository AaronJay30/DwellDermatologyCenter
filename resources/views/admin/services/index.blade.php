...
<div class="container">
    ...
    <div class="services-filters">
        <form method="GET" action="{{ route('admin.services') }}" id="filterForm" class="filter-form">
    ...
    <div class="card" style="padding: 1rem; border: 1px solid #eef1f4;">
        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:.75rem;">
            <h2 style="margin:0; color: var(--primary-color); font-size:1.15rem;">
                Services — {{ $branch->name }}
            </h2>
            @if($selectedCategoryId)
                <a href="{{ route('admin.services') }}" class="btn btn-accent">Reset</a>
            @endif
        </div>
                    ...
                    <div style="padding: 1rem; display:flex; flex-direction:column; gap:.5rem;">
                        ...
                        <div style="display:flex; justify-content:space-between; align-items:center; margin-top:.25rem;">
                            ...
                            <div style="display:flex; gap:.5rem;">
                                <a href="{{ route('admin.services.edit', $service) }}" class="btn btn-accent" style="padding:.35rem .6rem;">Edit</a>
                                <form method="POST" action="{{ route('admin.services.destroy', $service) }}" onsubmit="return confirm('Delete this service?');" style="margin:0;">
                                    @csrf
                                    @method('DELETE')
