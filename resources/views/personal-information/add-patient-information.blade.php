        ...
        <div class="form-section">
            ...
            <div class="form-group">
                ...
                <div style="margin-top: 0.5rem;">
                    <input type="text" name="comorbidities_others" placeholder="Others, please specify:" style="width: 100%; padding: 0.5rem; border: 1px solid #ccc; border-radius: 3px;">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="checkbox-group">
                    <label>
                        <input type="checkbox" name="allergies_medications" value="1">
                        Medications
                    </label>
                    <label>
                        <input type="checkbox" name="allergies_anesthetics" value="1">
                        Anesthetics
                    </label>
                </div>
                <div style="margin-top: 0.5rem;">
                    <input type="text" name="allergies_others" placeholder="Others, please specify:" style="width: 100%; padding: 0.5rem; border: 1px solid #ccc; border-radius: 3px;">
                </div>
            </div>

            <div class="form-group">
                <label for="previous_hospitalizations_surgeries">Previous hospitalizations / surgeries</label>
                <textarea id="previous_hospitalizations_surgeries" name="previous_hospitalizations_surgeries"></textarea>
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <div class="radio-group">
                        <label>
                            <input type="radio" name="alcoholic_drinker" value="Yes">
                            Yes
                        </label>
                        <label>
                            <input type="radio" name="alcoholic_drinker" value="No">
                            No
                        </label>
                    </div>
                </div>
            ...
            <div class="form-group">
                ...
                <textarea id="known_family_illnesses" name="known_family_illnesses"></textarea>
            </div>
        </div>
