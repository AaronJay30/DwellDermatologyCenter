...
<div class="form-container">
    <div class="page-header">
        ...
        <h1 class="page-title">Edit Emergency Contact</h1>
    </div>
    ...
    <div class="form-card">
        <form action="{{ route('emergency-contact.update', $emergencyContact) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="form-group">
                ...
                <input type="text" id="relationship" name="relationship" class="form-input" 
                       value="{{ old('relationship', $emergencyContact->relationship) }}" required>
            </div>

            <div class="form-group">
                <label for="address" class="form-label">Address</label>
                <textarea id="address" name="address" class="form-textarea" required>{{ old('address', $emergencyContact->address) }}</textarea>
            </div>

            <div class="form-group">
                <label for="contact_number" class="form-label">Contact Number</label>
                <input type="text" id="contact_number" name="contact_number" class="form-input" 
                       value="{{ old('contact_number', $emergencyContact->contact_number) }}" required>
            </div>

            <div class="checkbox-group">
                <input type="checkbox" id="is_default" name="is_default" value="1" 
                       {{ old('is_default', $emergencyContact->is_default) ? 'checked' : '' }}>
