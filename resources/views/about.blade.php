    ...
    <div class="container">
        <div class="about-content" style="max-width: 1000px; margin: 0 auto; padding: 0 20px;">
            ...
            <div class="about-header" style="text-align: center; margin-bottom: 60px;">
                <h1 style="font-size: 3rem; font-weight: bold; color: var(--primary-color); margin-bottom: 20px; font-family: serif;">About Dr. Dianne Salazar-Paras</h1>
            ...
            <div class="doctor-profile">
                ...
                <div class="doctor-photo">
                    <div class="doctor-photo-container">
                        <img src="{{ asset('images/dr-lazar-paras.png') }}" alt="Dr. Dianne Salazar-Paras" style="width: 100%; height: 100%; object-fit: cover;">
                    </div>
                    <div style="margin-top: 30px;">
                        <h3 style="font-size: 1.5rem; font-weight: bold; color: var(--black); margin-bottom: 10px;">Dr. Dianne Salazar-Paras</h3>
                        <p style="color: var(--primary-color); font-size: 1.1rem; font-weight: 500;">M.D. Dermatology · Chief Dermatologist & Founder</p>
                    </div>
                </div>
                    ...
                    <div class="doctor-info-box">
                        ...
                        <div style="font-size: 1.1rem; line-height: 1.8; color: var(--dark-text);">
                            <p style="margin-bottom: 25px;">
                                Dr. Dianne Salazar-Paras is a board-certified dermatologist with over 15 years of experience in medical and cosmetic dermatology. She founded Dwell Dermatology Center with a vision to provide personalized, comprehensive skin care that combines the latest medical advances with a warm, patient-centered approach.
                            </p>
                            
                            <p style="margin-bottom: 25px;">
                                After completing her medical degree at the University of the Philippines and her dermatology residency at the Philippine General Hospital, Dr. Salazar-Paras pursued advanced training in cosmetic dermatology in the United States. Her expertise spans across acne treatment, anti-aging therapies, skin cancer screening, and advanced laser procedures.
                            </p>
                            
                            <p style="margin-bottom: 25px;">
                                Dr. Salazar-Paras believes that healthy, beautiful skin is achievable for everyone through proper education, personalized treatment plans, and cutting-edge technology. She is passionate about empowering her patients with knowledge about their skin and providing them with the most effective, safe, and innovative treatments available.
                            </p>
                            
                            <p>
                                When not treating patients, Dr. Salazar-Paras enjoys spending time with her family, practicing yoga, and staying updated with the latest developments in dermatology through continuous education and research.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="cta-section">
                ...
                <p style="font-size: 1.2rem; margin-bottom: 40px; opacity: 0.9;">Book a consultation with Dr. Dianne Salazar-Paras and discover the personalized care that will transform your skin.</p>
